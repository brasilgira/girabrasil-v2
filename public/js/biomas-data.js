...
const BIOMAS = {
  ...
  amazonia: {
    ...
    fauna: [
      ...
      { nome: 'Uacari-vermelho', cientifico: 'Cacajao calvus', desc: 'Primata de rosto avermelhado e sem pelos, exclusivo de florestas alagadas da Amazônia.', status: 'Vulnerável', curiosidade: 'A cor vermelha intensa do rosto está ligada à sua saúde — indivíduos doentes costumam ter o rosto mais pálido.', habitat: 'Florestas de igapó, alagadas boa parte do ano.', dieta: 'Frutos e sementes, muitas vezes ainda não maduros.', papel: 'Dispersor de sementes especializado em florestas alagadas.' }
    ],
